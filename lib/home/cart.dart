...
class _cartState extends State<Cart> {
  ...
  void _loadSimilarProducts() {
    ...
    if (allAvailableProducts.isNotEmpty) {
      ...
      setState(() {
        ...
        debugPrint(
          'Cart: Loaded ${_similarProducts.length} similar products from ProductService.',
        );
      });
    } else {
      debugPrint(
        'Cart: ProductService returned no products for similar items. Using dummy fallback.',
      );
      setState(() {
    ...
    return Container(
      ...
      child: Shimmer.fromColors(
        ...
        child: Row(
          ...
          children: [
            Container(height: 128, width: 100, color: Colors.white),
  ...
  Widget _itemCard({
    ...
    final Color cardBackgroundColor =
        isDarkMode ? Colors.grey[900]! : Colors.orange.shade50.withOpacity(0.3);
    final Color borderColor =
        isDarkMode ? Colors.grey[700]! : Colors.grey.shade300;
    final Color textColor = isDarkMode ? Colors.white : Colors.black;
    final Color orangeColor = const Color(0xffEB7720);
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Unit Size: ${cartItem.selectedUnitSize}',
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        color: textColor,
                      ),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => ChangeNotifierProvider<Product>.value(
                            value: product,
