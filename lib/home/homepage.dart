  ...
  Future<void> _loadInitialData() async {
    ...
    if (mounted) {
      setState(() {
        ...
        _newOnKisangroItems =
            ProductService.getAllProducts().skip(0).take(10).toList();
  ...
  void _startCarousel() {
    ...
    _carouselTimer = Timer.periodic(const Duration(seconds: 3), (timer) {
      if (_pageController.hasClients && mounted) {
        ...
        final int itemCount =
            _ads.isNotEmpty ? _ads.length : _carouselImages.length;
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.lato(fontSize: 12, color: hintColor),
                      ),
                    ),
                    const SizedBox(height: 24),
                    SizedBox(
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) => const TrendingProductsScreen(),
                            ),
                          );
                        },
                        child: Text(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder:
                                          (context) => DealsOfTheDayScreen(
                                            deals:
                                                _dealsOfTheDay.map((deal) {
                                                  return Product(
                                                    mainProductId:
                                                        deal.proId.toString(),
      ...
      SizedBox(
        ...
        child: _dealsOfTheDay.isEmpty
            ...
            : ListView.builder(
                ...
                const SizedBox(height: 30),
                Divider(color: dividerColor, thickness: 8.0, height: 0),
                const SizedBox(height: 10),
                Padding(
                  padding: const EdgeInsets.symmetric(
                    horizontal: 12,
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) =>
                                      const NewOnKisangroProductsScreen(),
                            ),
                          );
                        },
                        child: Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            onTap: () {
              final categoryId = _getCategoryIdFromProduct(product);
              if (categoryId.isNotEmpty) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(8, 1, 6, 8),
